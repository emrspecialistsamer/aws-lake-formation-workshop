...
<div style="text-align: justify">
    ...
    <ol>
        ...
        <li>Select <b>Personal</b> as the Account Type and click on <b>CREATE ACCOUNT</b> button to finish up the sign up process.<img src="/images/auth0-personalaccount.png" style="margin:15px 0px; border:1px solid black"/></li>
    </ol>
</div>
