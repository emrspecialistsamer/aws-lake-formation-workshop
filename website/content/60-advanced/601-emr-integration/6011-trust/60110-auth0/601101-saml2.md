...
<div style="text-align: justify">
   ...
   <ol>
    ...
    <li>Log in to the Auth0 account, and create a new Application and enter "AWS SSO" for Name and Select Regular Web Application as application type and click on Create Button
